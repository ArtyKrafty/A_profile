...
[Репозиторий - Алгоритмические задачи](https://github.com/ArtyKrafty/Algo_tasks), [Репозиторий - Web-приложение для определения цены автомобиля](https://github.com/ArtyKrafty/CarPriceApp)
__________________________________________________________________________________________________________________________
__________________________________________________________________________________________________________________________
...
| [10. LastFM reccomendation system](https://nbviewer.jupyter.org/github/ArtyKrafty/Data_science_projects/blob/main/kaggel_last_fm/Last_fm_rec.ipynb)|Простая рекомендательная система|Завершен|
