...
03. [Репозиторий - Web-приложение для определения цены автомобиля](https://github.com/ArtyKrafty/CarPriceApp) и [Web-приложение](https://carpricepredictapp.herokuapp.com/)  (размещено на [Heroku](https://dashboard.heroku.com/login) - при переходе по ссылке потребуется некоторое время)
...
Для удобства, ссылки ведут сразу на данный сервис просмотра. Если нужны исходные файлы - переходи на соответствующий репозиторий [Репозиторий - Проекты Data Science](https://github.com/ArtyKrafty/Data_science_projects), [Репозиторий - Алгоритмы и структуры данных](https://github.com/ArtyKrafty/Algorithms),
[Репозиторий - Web-приложение для определения цены автомобиля](https://github.com/ArtyKrafty/CarPriceApp)
__________________________________________________________________________________________________________________________
__________________________________________________________________________________________________________________________

<p align="center"> Дипломный проект </p align="center">

| №| **Проект** | **Тип исследования** | **Статус** |
| -------------------- | -------------------- | :---------------------: |:---------------------------:|
| 01. | [Исследование оттока клиентов](https://nbviewer.jupyter.org/github/ArtyKrafty/Data_science_projects/) |Необходимо выяснить, что  пользователь планирует уйти. Тогда ему будут предложены промокоды и специальные условия.  | В процессе|
__________________________________________________________________________________________________________________________
__________________________________________________________________________________________________________________________
