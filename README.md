...
03. [Репозиторий - Web-приложение для определения цены автомобиля](https://github.com/ArtyKrafty/CarPriceApp) и [Web-приложение](https://carpricepredictapp.herokuapp.com/)  (размещено на heroku - при переходе по ссылке потребуется некоторое время)
