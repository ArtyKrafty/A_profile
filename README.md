...
| -------------------- | -------------------- | :--------------------- |:---------------------------:|
| 01. | [Исследование оттока клиентов](https://nbviewer.jupyter.org/github/ArtyKrafty/Data_science_projects/) |Необходимо выяснить, что  пользователь планирует уйти, и ему будут предложены промокоды и специальные условия.  | В процессе|
__________________________________________________________________________________________________________________________
__________________________________________________________________________________________________________________________
